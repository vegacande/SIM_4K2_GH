...
{
    public class LLegada_envios : Inicio
    {
        ...
        public LLegada_envios(Distribucion distro)
        {
            Nombre = "Llegada Cliente Envios";
            distribucion = distro;
        }

        public LLegada_envios(string nombre, double rND, double tiempoDeLlegada, double horaLlegada, Distribucion distribucion)
        {
            Nombre = nombre;
            RND = rND;
        ...
        public LLegada_envios(LLegada_envios llegadaCliente, Distribucion distribucion, bool keep)
        {
            if (keep)
            {
                this.distribucion = distribucion;
        ...
        public LLegada_envios(Distribucion distro, double nuevoReloj)
        {
            Nombre = "Llegada Cliente Envios";
            distribucion = distro;
            generarRND();
